...
//   'Apprentice' = show to everyone, 'Artisan' = only 41+, 'Virtuoso' = only 61+
const SIGNAL_PRIORITY = {
  ...
  'Usage activity':             { impact: 1, minTier: 'Apprentice' },
  ...
  'Claude co-authored commits': { impact: 2, minTier: 'Craftsperson' },
  ...
  'Workflow explorer':          { impact: 2, minTier: 'Craftsperson' },
  'Custom agents':              { impact: 2, minTier: 'Craftsperson' },

  // Advanced — suggest only to experienced users
  'Custom permissions':         { impact: 3, minTier: 'Artisan' },
  'Hooks configured':           { impact: 3, minTier: 'Artisan' },
  ...
  'Commit message quality':     { impact: 3, minTier: 'Artisan' },
  ...
  'Agent depth':                { impact: 3, minTier: 'Virtuoso' },
  'Team/swarm usage':           { impact: 3, minTier: 'Virtuoso' },
  'Team complexity':            { impact: 3, minTier: 'Virtuoso' },
  'Agent memory populated':     { impact: 3, minTier: 'Virtuoso' },
  'Secrets manager MCP':        { impact: 3, minTier: 'Virtuoso' },
...
const RECOMMENDATIONS = {
  ...
  'Secrets manager MCP':
    'Connect a secrets manager MCP (wiom-secrets, 1password, etc.) — Claude can securely use your API keys without ever seeing the actual values',
